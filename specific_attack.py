...
print(pos_df.loc[0]['content'])
for each in pos_df.loc[0]['attack_comms_spec']:
    print(each)
...
print(neg_df.loc[0]['content'])
for each in neg_df.loc[0]['attack_comms_spec']:
    print(each)
#df_out = pd.concat([pos_df, neg_df])
print(df_out)
